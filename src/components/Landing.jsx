  ...
  return (
    <div className="relative w-full h-[66vh] bg-gradient-to-b from-blue-50 to-white">
      <img
        src={banner}
        alt="banner"
        className="w-full h-[66vh] opacity-90 object-cover shadow-2xl"
      ></img>
      <div className="w-full h-[25vh] bg-gradient-to-r from-blue-50 via-white to-blue-50 py-8">
        <h1 className="text-4xl text-blue-600 flex justify-center font-extrabold m-4 tracking-wide drop-shadow-lg">
          Welcome To Trackr
        </h1>
        <p className="text-4xl text-blue-900 flex justify-center font-bold px-4 text-center leading-tight drop-shadow-md">
      ...
      >
        <div className="flex m-4 items-center">
          ...
          <h1 className="text-4xl font-bold text-blue-500 animate-bounce drop-shadow-lg">
            Did You Know?
          </h1>
        </div>
        <div className="flex justify-center mr-3 px-4">
          <div className="max-w-4xl bg-white rounded-2xl shadow-2xl p-8 border border-blue-100">
            ...
            <p className="text-2xl text-blue-800 mb-6 text-justify m-2 ml-3 text-wrap leading-relaxed">
              But many students miss important deadlines due to a lack of
              organized tracking.{" "}
              <span className="font-semibold text-blue-600">
                Trackr is here to fix that.
              </span>
            </p>
          </div>
          <StatsChart />
        ...
        <div className="bg-gradient-to-r from-blue-50 to-white py-8 mt-8">
          <p className="text-3xl text-blue-900 font-bold text-wrap m-3 text-center drop-shadow-md">
            Explore the key features that help students stay organized and
            informed.
          </p>
        </div>
        <div className="flex gap-8 justify-center m-6 px-4">
          ...
          <div
            ...
            data-aos-delay="100"
          >
            📅 Stay Ahead — Get Notified Before Every Exam & Application
            Deadline!
          </div>
